...
public class JwtAuthorizationFilter extends OncePerRequestFilter { // HttpServletRequest, HttpServletReseponse 상속받으려고 사용
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (StringUtils.hasText(tokenValue)) {
            // JWT 토큰 substring
            tokenValue = jwtUtil.substringToken(tokenValue); // bearer 떼어주기
            log.info(tokenValue);
